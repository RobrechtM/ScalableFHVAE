...
parser.add_argument("--ftype", type=str, default="fbank", choices=["fbank", "spec"],
        help="feature type")
parser.add_argument("--out_dir", type=str, default="./datasets/cgn_np_fbank",
        help="output data directory")
parser.add_argument("--dev_spk", type=str, default="./misc/cgn_dev_spk.list",
        help="path to list of dev set speakers")
parser.add_argument("--test_spk", type=str, default="./misc/cgn_test_spk.list",
...
for root, _, fnames in sorted(os.walk(args.cgn_dir)):
    ...
    if comp not in ["comp-o","comp-l","comp-m","comp-n"]:
        continue
    for fname in fnames:
